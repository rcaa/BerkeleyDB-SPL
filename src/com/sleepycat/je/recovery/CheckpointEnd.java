 ...
 *
 * $Id: CheckpointEnd.java,v 1.1.6.1 2006/07/28 09:02:55 ckaestne Exp $
 */
...
public class CheckpointEnd implements LoggableObject, LogReadable {
	...
	public CheckpointEnd(String invoker, long checkpointStartLsn, long rootLsn,
			long firstActiveLsn, long lastNodeId, int lastDbId, long lastTxnId,
			long id) {
		if (invoker == null) {
			this.invoker = "";
		} else {
