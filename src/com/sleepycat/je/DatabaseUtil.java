 ...
 *
 * $Id: DatabaseUtil.java,v 1.1.6.1.2.1 2006/10/22 01:08:22 ckaestne Exp $
 */
 ...
 */
//Made visible during refactoring
public class DatabaseUtil {
	 ...
	 */
	static void checkForNullDbt(DatabaseEntry dbt, String name,
			boolean checkData) {
		if (dbt == null) {
			throw new NullPointerException("DatabaseEntry " + name
					+ " cannot be null");
		}

		if (checkData) {
			if (dbt.getData() == null) {
				throw new NullPointerException("Data field for DatabaseEntry "
						+ name + " cannot be null");
			}
		}
	}
