 ...
 *
 * $Id: AutoTxn.java,v 1.1.6.1 2006/07/28 09:01:37 ckaestne Exp $
 */
...
public class AutoTxn extends Txn {
	...
	/**
	 * Transfer any handle locks to the db handle on success. On failure, leave
	 * it with this txn, the handle lock will be released at abort and the
	 * handle marked invalid.
	 */
	public void setHandleLockOwner(boolean operationOK, Database dbHandle,
			boolean dbIsClosing) throws DatabaseException {
