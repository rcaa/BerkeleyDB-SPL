 ...
 *
 * $Id: LockUpgrade.java,v 1.1.6.1 2006/07/28 09:01:32 ckaestne Exp $
 */
...
class LockUpgrade {
	...
	static final LockUpgrade WRITE_PROMOTE = new LockUpgrade(LockType.WRITE,
			true, false);
	...
	/**
	 * This method is called to determine whether the upgrade is illegal. If
	 * true is returned, an internal error has occurred. This should never
	...
	/**
	 * This method is called first to determine whether an upgrade to a new lock
	 * type is needed, and what the new lock type should be. If null is
	 * returned, the existing lock should be unchanged and no upgrade is needed.
	 * If non-null is returned, an upgrade to the returned type should be
	 * performed; in this case, call getPromotion to determine how to do the
	 * upgrade.
	 */
	LockType getUpgrade() {
		return upgrade;
	 ...
	 * whether the upgrade is a true promotion or can be granted immediately. A
	 * true promotion is a change from read to write locking, and may require
