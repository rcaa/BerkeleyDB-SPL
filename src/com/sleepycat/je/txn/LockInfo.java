 ...
 *
 * $Id: LockInfo.java,v 1.2.6.2 2006/07/28 14:07:26 ckaestne Exp $
 */
...
public class LockInfo implements Cloneable {
	...
	private static Map traceExceptionMap = Collections
	...
	public String toString() {
		...
		if (deadlockStackTrace) {
			...
			if (traceException != null) {
				...
				buf.append(StackTraceUtil.getStackTrace(traceException));
			}
		}
