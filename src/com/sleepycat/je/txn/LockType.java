 ...
 *
 * $Id: LockType.java,v 1.1.6.1 2006/07/28 09:01:36 ckaestne Exp $
 */
 ...
 * objects can be used to determine whether a type conflicts with another type
 * or can be upgraded to another type.
 */
public class LockType {
	...
	public static final LockType RANGE_READ = new LockType(2, false,
			"RANGE_READ");

	public static final LockType RANGE_WRITE = new LockType(3, true,
			"RANGE_WRITE");

	public static final LockType RANGE_INSERT = new LockType(4, false,
			"RANGE_INSERT");
	...
	/**
	 * Whenever the conflict matrix is changed be sure to update this. For every
	 * type that can cause a RESTART result call setCausesRestart. This could
	 * have been determined programmatically but I chose to maintain it manually
	 * to avoid extra code size.
	 */
	static {
	 ...
	 * @see #getConflict
	 */
	private static LockConflict[][] conflictMatrix = { { // READ is held and
															// there is a
															// request for:
	 ...
	 * @see #getUpgrade
	 */
	private static LockUpgrade[][] upgradeMatrix = { { // READ is held and
														// there is a request
														// for:
	 ...
	 * 
	 * <p>
	 * For the returned LockUpgrade object, getIllegal will never return true
	 * because this method fires an assertion if getIllegal returns true.
	 */
