 ...
 *
 * $Id: UtilizationTracker.java,v 1.1.6.1.2.6 2006/10/26 16:36:48 ckaestne Exp $
 */
...
public class UtilizationTracker {
	 ...
	 */
	//TODO needed to introduce a DatabaseException, because the cleaner is now run synchronously by default
	public void activateCleaner() throws DatabaseException {
		env.invokeCleaner();
	...
	public void newPendingLN() throws DatabaseException {
		//do nothing by default.
		//using the cleanerDaemon this that is invoked, otherwise the cleaner must be called manually
	}
}
