 ...
 *
 * $Id: OffsetList.java,v 1.2.6.2.2.2 2006/10/23 17:22:03 ckaestne Exp $
 */
...
public class OffsetList {
	...
	public boolean add(long value, boolean checkDupOffsets) {
		...
		if (checkDupOffsets) {
//TODO			assert (!contains(value)) : Tracer.getStackTrace(new Exception(
//					"Dup Offset " + Long.toHexString(value)));
		}
	 ...
	 * to the list while this method is excuting, some values may be missing
