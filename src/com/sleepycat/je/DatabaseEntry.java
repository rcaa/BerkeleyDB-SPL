 ...
 *
 * $Id: DatabaseEntry.java,v 1.1.6.1 2006/07/28 09:02:24 ckaestne Exp $
 */
...
public class DatabaseEntry {
	 ...
	 * 
	 * <p>
	 * In either entry, if the offset is non-zero or the size is not equal to
	 * the data array length, then only the data bounded by these values is
	 * compared. The data array length and offset need not be the same in both
	 * entries for them to be considered equal.
	 * </p>
	 * 
	 * <p>
	 * If the data array is null in one entry, then to be considered equal both
	 * entries must have a null data array.
	 * </p>
	 * 
	 * <p>
