 ...
 *
 * $Id: EnvironmentConfig.java,v 1.1.6.3.2.1 2006/10/19 17:29:16 ckaestne Exp $
 */
...
public class EnvironmentConfig extends EnvironmentMutableConfig {
	...
	public long getLockTimeout() {
		...
		try {
			...
			throw new IllegalArgumentException("Bad value for timeout:"
					+ e.getMessage());
		}
		return timeout;
	}
	...
	public void setTxnSerializableIsolation(boolean txnSerializableIsolation) {
		...
		setVal(EnvironmentParams.TXN_SERIALIZABLE_ISOLATION, Boolean
				.toString(txnSerializableIsolation));
	}
