 ...
 *
 * $Id: CmdUtil.java,v 1.1.6.1 2006/07/28 09:02:53 ckaestne Exp $
 */
...
public class CmdUtil {
	...
	public static void formatEntry(StringBuffer sb, byte[] entryData,
	...
	public static EnvironmentImpl makeUtilityEnvironment(File envHome,
		...
		/* Don't run recovery. */
		config
				.setConfigParam(EnvironmentParams.ENV_RECOVERY.getName(),
						"false");
