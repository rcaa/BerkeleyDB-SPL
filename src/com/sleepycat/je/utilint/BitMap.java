 ...
 *
 * $Id: BitMap.java,v 1.1.6.1 2006/07/28 09:02:53 ckaestne Exp $
 */
...
/**
 * Bitmap which supports indexing with long arguments. java.util.BitSet provides
 * all the functionality and performance we need, but requires integer indexing.
 * 
...
public class BitMap {
	...
	/*
	 * Since the BitMap is implemented by a collection of BitSets, return the
	 * one which covers the numeric range for this index.
	 * 
	 * @param index the bit we want to access @param allowCreate if true, return
	 * the BitSet that would hold this index even if it wasn't previously set.
	 * If false, return null if the bit has not been set.
	 */
