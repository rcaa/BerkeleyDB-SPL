 ...
 *
 * $Id: BooleanConfigParam.java,v 1.1.6.1.2.2 2007/02/27 17:45:16 ckaestne Exp $
 */
...
public class BooleanConfigParam extends ConfigParam {
	 ...
	 */
	//Lck made public
	BooleanConfigParam(String configName, boolean defaultValue,
			boolean mutable, String description) {
