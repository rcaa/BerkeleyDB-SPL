 ...
 *
 * $Id: ConfigParam.java,v 1.1.6.1 2006/07/28 09:02:42 ckaestne Exp $
 */

package com.sleepycat.je.config;

/**
 * A ConfigParam embodies the metatdata about a JE configuration parameter: the
 * parameter name, default value, and a validation method.
 * 
	...
	private void validateName(String name) throws IllegalArgumentException {
		...
		if ((name == null) || (name.length() < 1)) {
			throw new IllegalArgumentException(" A configuration parameter"
					+ " name can't be null or 0" + " length");
		}
	}
