 ...
 *
 * $Id: ShortConfigParam.java,v 1.1.6.1 2006/07/28 09:02:42 ckaestne Exp $
 */
...
public class ShortConfigParam extends ConfigParam {
	...
	ShortConfigParam(String configName, Short minVal, Short maxVal,
			Short defaultValue, boolean mutable, String description) {
