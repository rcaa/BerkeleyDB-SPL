 ...
 *
 * $Id: BINDeltaLogEntry.java,v 1.1.6.1 2006/07/28 09:02:34 ckaestne Exp $ 
 */
 ...
 */
public class BINDeltaLogEntry extends SingleItemLogEntry implements
		INContainingEntry {
	...
	/**
	 * @return the LSN that represents this IN. For this BINDelta, it's the last
	 *         full version.
	 */
