 ...
 *
 * $Id: INLogEntry.java,v 1.1.6.1 2006/07/28 09:02:34 ckaestne Exp $
 */
 ...
 */
public class INLogEntry implements LogEntry, LoggableObject, NodeLogEntry,
		INContainingEntry {
	...
	/**
	 * Returns the LSN of the prior version of this node. Used for counting the
	 * prior version as obsolete. If the offset of the LSN is zero, only the
	...
	/**
	 * @see LoggableObject#marshallOutsideWriteLatch Ask the in if it can be
	...
	/**
	 * @return the LSN that represents this IN. For a vanilla IN entry, it's the
	 *         last lsn read by the log reader.
	 */
