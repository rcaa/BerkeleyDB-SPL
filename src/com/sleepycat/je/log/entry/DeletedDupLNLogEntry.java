 ...
 *
 * $Id: DeletedDupLNLogEntry.java,v 1.1.6.1 2006/07/28 09:02:35 ckaestne Exp $
 */
...
public class DeletedDupLNLogEntry extends LNLogEntry {
	...
	/*
	 * Deleted duplicate LN must log an entra key in their log entries, because
	 ...
	 */
	public DeletedDupLNLogEntry(LogEntryType entryType, LN ln, DatabaseId dbId,
			byte[] key, byte[] dataAsKey, long abortLsn,
			boolean abortKnownDeleted, Txn txn) {
