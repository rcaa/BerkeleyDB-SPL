 ...
 *
 * $Id: PrintFileReader.java,v 1.1.6.1.2.1 2006/10/12 16:53:18 ckaestne Exp $
 */
...
public class PrintFileReader extends DumpFileReader {
	 ...
	 */
	public PrintFileReader(EnvironmentImpl env, int readBufferSize,
	...
	protected boolean processEntry(ByteBuffer entryBuffer)
		...
		sb.append("<entry lsn=\"0x")
				.append(Long.toHexString(readBufferFileNum));
	...
	private void hook_printChecksum(StringBuffer sb) {
