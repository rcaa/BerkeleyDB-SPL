 ...
 *
 * $Id: CheckpointFileReader.java,v 1.1.6.1 2006/07/28 09:01:46 ckaestne Exp $
 */
...
public class CheckpointFileReader extends FileReader {
	 ...
	 */
	public CheckpointFileReader(EnvironmentImpl env, int readBufferSize,
			boolean forward, long startLsn, long finishLsn, long endOfFileLsn)
