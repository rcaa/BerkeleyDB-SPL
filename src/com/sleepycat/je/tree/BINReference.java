 ...
 *
 * $Id: BINReference.java,v 1.1.6.1 2006/07/28 09:02:04 ckaestne Exp $
 */
...
public class BINReference {
	...
	public String toString() {
		return "idKey=" + Key.getNoFormatString(idKey) + " nodeId = " + nodeId
				+ " db=" + databaseId + " deletedKeys=" + deletedKeys;
	}
}
