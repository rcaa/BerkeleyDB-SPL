 ...
 *
 * $Id: INDupDeleteInfo.java,v 1.1.6.1 2006/07/28 09:01:58 ckaestne Exp $
 */
 ...
 */
public class INDupDeleteInfo implements LoggableObject, LogReadable,
		LogWritable {
	 ...
	 */
	public INDupDeleteInfo(long deletedNodeId, byte[] deletedMainKey,
			byte[] deletedDupKey, DatabaseId dbId) {
