 ...
 *
 * $Id: DupCountLN.java,v 1.1.6.1.2.3 2006/10/25 17:21:16 ckaestne Exp $
 */
 ...
 * tree, specifically the count of dupes in the tree.
 */
public final class DupCountLN extends LN {
	...
	public DupCountLN(int count) {
		...
		/*
		 * This ctor is always called from Tree.createDuplicateEntry where there
		 * will be one existing LN and a new dup LN being inserted to create the
		 * new duplicate tree. So the minimum starting point for a duplicate
		 * tree is 2 entries.
		 */
		this.dupCount = count;
	}
