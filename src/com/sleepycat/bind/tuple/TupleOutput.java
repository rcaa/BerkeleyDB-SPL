 ...
 *
 * $Id: TupleOutput.java,v 1.1.6.1 2006/07/28 09:02:27 ckaestne Exp $
 */
 ...
 * {@link java.io.DataOutput} interface. The reason this class does not
...
public class TupleOutput extends FastOutputStream {
	 ...
	 * {@link TupleInput#readBytes}. Only characters with values below 0x100
	 ...
	 * parameter is encoded as 0xFF. Writes values that can be read using
	 * {@link TupleInput#readString()}.
	 * 
	 * @param val
	 *            is the string containing the characters to be written.
	 * 
	 ...
	 * non-zero values. Writes values that can be read using
