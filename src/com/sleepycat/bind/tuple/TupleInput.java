 ...
 *
 * $Id: TupleInput.java,v 1.1.6.1 2006/07/28 09:02:26 ckaestne Exp $
 */
...
public class TupleInput extends FastInputStream {
	...
	public TupleInput(TupleOutput output) {
		...
		super(output.getBufferBytes(), output.getBufferOffset(), output
				.getBufferLength());
	}
	 ...
	 * data from UTF to Unicode. Reads values that were written using {@link
