 ...
 *
 * $Id: StringBinding.java,v 1.1.6.2 2006/07/28 14:07:34 ckaestne Exp $
 */
 ...
 * a binding instance is with the {@link TupleBinding#getPrimitiveBinding}
 * method.</li>
 * </ol>
 */
public class StringBinding extends TupleBinding {
	...
	private static TupleOutput sizedOutput(String val) {
		...
		int stringLength = (val == null) ? 1 : UtfOps.getByteLength(val
				.toCharArray());
