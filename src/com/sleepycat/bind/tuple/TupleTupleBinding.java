 ...
 *
 * $Id: TupleTupleBinding.java,v 1.1.6.1 2006/07/28 09:02:28 ckaestne Exp $
 */
 ...
 * @author Mark Hayes
 */
public abstract class TupleTupleBinding extends TupleBase implements
		EntityBinding {
	...
	public Object entryToObject(DatabaseEntry key, DatabaseEntry data) {
		...
		return entryToObject(TupleBinding.entryToInput(key), TupleBinding
				.entryToInput(data));
	}
	 ...
	 * 
	 * @param keyInput
	 *            is the {@link TupleInput} key entry object.
	 * 
	 * @param dataInput
	 *            is the {@link TupleInput} data entry object.
	 * 
	 ...
	 * 
	 * @param output
	 *            is the {@link TupleOutput} to which the key should be written.
	 */
	 ...
	 * 
	 * @param output
	 *            is the {@link TupleOutput} to which the data should be
	 *            written.
	 */
