 ...
 *
 * $Id: TupleInputBinding.java,v 1.1.6.1 2006/07/28 09:02:26 ckaestne Exp $
 */
 ...
 * 
 * A concrete tuple binding for key or data entries which are {@link TupleInput}
 * objects. This binding is used when tuples themselves are the objects, rather
 * than using application defined objects. A {@link TupleInput} must always be
 * used. To convert a {@link TupleOutput} to a {@link TupleInput}, use the
