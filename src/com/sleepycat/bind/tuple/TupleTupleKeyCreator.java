 ...
 *
 * $Id: TupleTupleKeyCreator.java,v 1.1.6.1 2006/07/28 09:02:30 ckaestne Exp $
 */
 ...
 * TupleInput} and {@link TupleOutput} objects. The following abstract method
 ...
 * @author Mark Hayes
 */
public abstract class TupleTupleKeyCreator extends TupleBase implements
		SecondaryKeyCreator, ForeignKeyNullifier {
	 ...
	 * 
	 * @param primaryKeyInput
	 *            is the {@link TupleInput} for the primary key entry.
	 * 
	 * @param dataInput
	 *            is the {@link TupleInput} for the data entry.
	 * 
	 * @param indexKeyOutput
	 ...
	 * 
	 * <p>
	 * The secondary key should be output or removed by this method such that
	 * {@link #createSecondaryKey} will return false. Other fields in the data
	 ...
	 * 
	 * @param dataOutput
	 *            is the destination {@link TupleOutput}.
	 * 
