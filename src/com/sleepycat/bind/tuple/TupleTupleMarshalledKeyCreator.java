 ...
 *
 * $Id: TupleTupleMarshalledKeyCreator.java,v 1.1.6.1 2006/07/28 09:02:29 ckaestne Exp $
 */
 ...
 * TupleTupleMarshalledBinding}. This key creator works by calling the methods
...
public class TupleTupleMarshalledKeyCreator extends TupleTupleKeyCreator {
	 ...
	 * 
	 * @param binding
	 *            is the binding used for the tuple-tuple entity.
	 * 
	 * @param keyName
