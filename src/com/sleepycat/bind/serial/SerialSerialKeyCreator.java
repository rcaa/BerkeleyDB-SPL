 ...
 *
 * $Id: SerialSerialKeyCreator.java,v 1.1.6.1 2006/07/28 09:02:40 ckaestne Exp $
 */
 ...
 * @author Mark Hayes
 */
public abstract class SerialSerialKeyCreator implements SecondaryKeyCreator,
		ForeignKeyNullifier {
	 ...
	 * 
	 * @param classCatalog
	 *            is the catalog to hold shared class information and for a
	 *            database should be a {@link StoredClassCatalog}.
	 * 
	 * @param primaryKeyClass
	 *            is the primary key base class.
	 * 
	 * @param dataClass
	 *            is the data base class.
	 * 
	 * @param indexKeyClass
	 *            is the index key base class.
	 */
	public SerialSerialKeyCreator(ClassCatalog classCatalog,
		...
		this(new SerialBinding(classCatalog, primaryKeyClass),
				new SerialBinding(classCatalog, dataClass), new SerialBinding(
						classCatalog, indexKeyClass));
	}

	/**
	 * Creates a serial-serial entity binding.
	 * 
	 * @param primaryKeyBinding
	 *            is the primary key binding.
	 * 
	 * @param dataBinding
	 *            is the data binding.
	 * 
	 * @param indexKeyBinding
	 *            is the index key binding.
	 */
	public SerialSerialKeyCreator(SerialBinding primaryKeyBinding,
			SerialBinding dataBinding, SerialBinding indexKeyBinding) {
	...
	public boolean createSecondaryKey(SecondaryDatabase db,
			DatabaseEntry primaryKeyEntry, DatabaseEntry dataEntry,
			DatabaseEntry indexKeyEntry) throws DatabaseException {

		Object primaryKeyInput = primaryKeyBinding
	...
	public boolean nullifyForeignKey(SecondaryDatabase db,
			DatabaseEntry dataEntry) throws DatabaseException {
	 ...
	 * 
	 * @param primaryKey
	 *            is the deserialized source primary key entry, or null if no
	 *            primary key entry is used to construct the index key.
	 * 
	 * @param data
	 *            is the deserialized source data entry, or null if no data
