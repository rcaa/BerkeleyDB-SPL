 ...
 *
 * $Id: TupleSerialKeyCreator.java,v 1.1.6.1 2006/07/28 09:02:38 ckaestne Exp $
 */
 ...
 * @author Mark Hayes
 */
public abstract class TupleSerialKeyCreator extends TupleBase implements
	 ...
	 *            is the {@link TupleInput} for the primary key entry, or null
	 *            if no primary key entry is used to construct the index key.
	 * 
	 * @param dataInput
	 *            is the deserialized data entry, or null if no data entry is
	 *            used to construct the index key.
	 * 
	 * @param indexKeyOutput
	 *            is the destination index key tuple. For index keys which are
	 ...
	 * 
	 * @param data
	 *            is the source and destination deserialized data entry.
	 * 
