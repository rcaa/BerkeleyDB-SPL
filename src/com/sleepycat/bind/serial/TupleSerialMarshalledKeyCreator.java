 ...
 *
 * $Id: TupleSerialMarshalledKeyCreator.java,v 1.1.6.1 2006/07/28 09:02:39 ckaestne Exp $
 */
 ...
 * TupleSerialMarshalledBinding}. This key creator works by calling the methods
...
public class TupleSerialMarshalledKeyCreator extends TupleSerialKeyCreator {
	 ...
	 * 
	 * @param binding
	 *            is the binding used for the tuple-serial entity.
	 * 
	 * @param keyName
	 *            is the key name passed to the {@link
	 *            MarshalledTupleKeyEntity#marshalSecondaryKey} method to
	 *            identify the index key.
	 */
	public TupleSerialMarshalledKeyCreator(
			TupleSerialMarshalledBinding binding, String keyName) {
	...
	public boolean createSecondaryKey(TupleInput primaryKeyInput,
		 ...
		 * primary key.
		 */
		MarshalledTupleKeyEntity entity = (MarshalledTupleKeyEntity) binding
				.entryToObject(primaryKeyInput, dataInput);
