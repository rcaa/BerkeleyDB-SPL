 ...
 *
 * $Id: ClassCatalog.java,v 1.1.6.1 2006/07/28 09:02:38 ckaestne Exp $
 */
 ...
 * serialized objects are stored in a database, a {@link StoredClassCatalog}
 * should be used.
 * </p>
 * 
 * <p>
 ...
 * full class information. When used with {@link SerialInput} and
 * {@link SerialOutput} or any of the serial bindings, the use of the catalog is
...
public interface ClassCatalog {
	 ...
	 * the ObjectStreamClass for a class ID, call
	 * {@link #getClassFormat(byte[])}. This function causes a new class ID to
	 * be assigned if the class description has changed.
	 * 
	 * @param classDesc
	 *            The class description for which to return the class ID.
	 * 
