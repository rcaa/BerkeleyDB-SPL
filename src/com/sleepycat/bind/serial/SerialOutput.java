 ...
 *
 * $Id: SerialOutput.java,v 1.1.6.1 2006/07/28 09:02:39 ckaestne Exp $
 */
 ...
 * embedded into the stream. This identifier is then used by {@link SerialInput}
...
public class SerialOutput extends ObjectOutputStream {
	 ...
	 * by creating a SerialOutput, which itself guarantees that we'll always use
	 * a PROTOCOL_VERSION_2 header.
	 */
	 ...
	 * 
	 * @param classCatalog
	 *            is the catalog to which the class descriptions for the
