 ...
 *
 * $Id: TupleSerialMarshalledBinding.java,v 1.1.6.1 2006/07/28 09:02:39 ckaestne Exp $
 */
...
public class TupleSerialMarshalledBinding extends TupleSerialBinding {
	 ...
	 * 
	 * @param dataBinding
	 *            is the binding used for serializing and deserializing the
	 *            entity object.
	 */
	...
	public Object entryToObject(TupleInput tupleInput, Object javaInput) {
		...
		/*
		 * Creates the entity by combining the stored key and data. This
		 * "tricky" binding returns the stored data as the entity, but first it
		 * sets the transient key fields from the stored key.
		 */
