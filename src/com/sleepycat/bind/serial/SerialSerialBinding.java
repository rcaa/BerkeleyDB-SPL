 ...
 *
 * $Id: SerialSerialBinding.java,v 1.1.6.1 2006/07/28 09:02:40 ckaestne Exp $
 */
...
public abstract class SerialSerialBinding implements EntityBinding {
	 ...
	 * 
	 * @param keyClass
	 *            is the key base class.
	 * 
	 * @param dataClass
	 *            is the data base class.
	 */
	public SerialSerialBinding(ClassCatalog classCatalog, Class keyClass,
			Class dataClass) {

		this(new SerialBinding(classCatalog, keyClass), new SerialBinding(
				classCatalog, dataClass));
	}
	...
	public Object entryToObject(DatabaseEntry key, DatabaseEntry data) {
		...
		return entryToObject(keyBinding.entryToObject(key), dataBinding
				.entryToObject(data));
	}
	 ...
	 * 
	 * @param keyInput
	 *            is the deserialized key object.
	 * 
	 * @param dataInput
